...
Theorem mult_n_1 : forall p : nat,
  p * 1 = p.
Proof.
  intros. rewrite <- mult_n_Sm, <- mult_n_O. reflexivity.
Qed.
...
Proof.
  intros. unfold apply_late_policy. rewrite H. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros. unfold apply_late_policy. rewrite H, H0. reflexivity.
Qed.
(** [] *)
End LateDays.
