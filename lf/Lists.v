...
Proof.
  intros. assert (f (f n1) = f (f n2)).
  { rewrite H0. reflexivity. }
  rewrite H with n1, H with n2, H1. reflexivity.
Qed.
(** [] *)
...
Theorem rev_injective : forall (l1 l2 : natlist),
  rev l1 = rev l2 -> l1 = l2.
Proof.
  intros. assert(rev (rev l1) = rev (rev l2)).
  { rewrite H. reflexivity. }
  rewrite <-rev_involutive with l1, <-rev_involutive with l2, H0. reflexivity.
Qed.
(** [] *)
